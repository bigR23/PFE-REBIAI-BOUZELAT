...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de TV &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
...
<?php 
     ...
     ?>
     <li>
     <a>ID=<?= $tv['id'];?>) </a><a href="TV-déclarés/<?= $tv['photo'];?>">TV <?=$tv['marque'];?> :</a> <a href="justificatifs -TV/<?= $tv['justificatif'];?>">Justificatif</a>
     <a href="supprimer-déclaration-tv.php?table=tv&id=<?php echo $tv['id'];?>&nums=<?php echo $tv['num_s'];?>&just=<?= $tv['justificatif'];?>&photo=<?= $tv['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-tv.php?table=tv&id=<?php echo $tv['id'];?>&nums=<?php echo $tv['num_s'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
<?php endforeach  ?>

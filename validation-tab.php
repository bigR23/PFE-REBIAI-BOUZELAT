...
if(isset($_SESSION['nomadmin'])){
 ...
 $userinfo=$requser->fetch();
   ...
   if($table=="tablette"){   
        $imei=$_GET['imei'];
        $reqvalider=$pdo->prepare("UPDATE tablette SET confirmation=? WHERE emei=? AND id=?");
...
<link rel="stylesheet" href="css/all.css"/>
		...
		align="center">
			<br />
			<p style="font-size:1.3em;color:#fff ;margin: 20px 0px;text-shadow:0 0 4px #000000;"> Votre déclaration de tablettee à était <strong style="color:rgb(0,236,173);">acceptée </strong> par nos services</p>
...
; header("Location:admin-tab.php?msg2=déclaration-validée&nomadmin=".$ad);
   }

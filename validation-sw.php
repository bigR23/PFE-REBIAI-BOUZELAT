...
if(isset($_SESSION['nomadmin'])){
 ...
 $userinfo=$requser->fetch();
   ...
   if($table=="smart_watch"){   
        $imei=$_GET['imei'];
        $reqvalider=$pdo->prepare("UPDATE smart_watch SET confirmation=? WHERE imei=? AND id=?");
        $reqvalider->execute(array('OK',$imei,$ID));}
...
<link rel="stylesheet" href="css/all.css"/>
		...
		align="center">
			<br />
			<p style="font-size:1.3em;color:#fff ;margin: 20px 0px;text-shadow:0 0 4px #000000;"> Votre déclaration de Smart Watch à était <strong style="color:rgb(0,236,173);">acceptée </strong> par nos services</p>
...
; header("Location:admin-sw.php?msg2=déclaration-validée&nomadmin=".$ad);
   }
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="admin-sw.php?nomadmin=<?=$ad?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
    </header>

...
$reqapp=$pdo->prepare("SELECT *FROM velo WHERE num_s= ? AND confirmation='OK' ");
...
$_SESSION['type_velo']=$appinfo['type_velo'];
...
<link rel="stylesheet" href="css/all.css"/>
		...
		align="center">
			<br />
			<p style="font-size:1.3em;color:#fff ;margin: 20px 0px;text-shadow:0 0 4px #000000;"> Votre vélo a été retrouvé par un utilisateur de notre application,
...
mail($mail, "Votre vélo a été retrouvé !", $message, $header);
header("Location:vélo-volé.php?num=$number&nums=".$_SESSION['num_s']);

}else{
  header("Location:objet-n'est-pas-déclaré.php?num=$number&objet=le vélo");
}
}
else {
...
?> </header>
  <h2>Détection du vélo par numéro de série<script src="https://cdn.lordicon.com/lusqsztk.js"></script>
    <lord-icon

...
if(isset($_SESSION['nomadmin'])){
 ...
 $userinfo=$requser->fetch();
   ...
   if($table=="moto"){   
        ...
        $reqvalider=$pdo->prepare("UPDATE moto SET confirmation=? WHERE num_chassis=? AND id=?");
        $reqvalider->execute(array('OK',$numchassis,$ID));}
...
<link rel="stylesheet" href="css/all.css"/>
		...
		align="center">
			<br />
			<p style="font-size:1.3em;color:#fff ;margin: 20px 0px;text-shadow:0 0 4px #000000;"> Votre déclaration de moto à était <strong style="color:rgb(0,236,173);">acceptée </strong> par nos services</p>
...
; header("Location:admin-moto.php?msg2=déclaration-validée&nomadmin=".$ad);
   }
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="admin-moto.php?nomadmin=<?=$ad?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
    </header>

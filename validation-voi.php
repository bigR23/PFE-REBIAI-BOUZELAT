...
if(isset($_SESSION['nomadmin'])){
 ...
 $userinfo=$requser->fetch();
   ...
   if($table=="voiture"){   
        ...
        $reqvalider=$pdo->prepare("UPDATE voiture SET confirmation=? WHERE num_chassis=? AND id=?");
...
<link rel="stylesheet" href="css/all.css"/>
		...
		align="center">
			<br />
			<p style="font-size:1.3em;color:#fff ;margin: 20px 0px;text-shadow:0 0 4px #000000;"> Votre déclaration de voiture à était <strong style="color:rgb(0,236,173);">acceptée </strong> par nos services</p>
...
; header("Location:admin-voiture.php?msg2=déclaration-validée&nomadmin=".$ad);
   }

...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de motos &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
...
<?php 
     ...
     ?>
     <li>
         <a>ID=<?= $moto['id'];?>) </a> <a href="motos-déclarés/<?= $moto['photo'];?>"><?=$moto['nom_moto'];?> :</a> <a href="justificatifs-moto/<?= $moto['justificatif'];?>">Justificatif</a>
         <a href="supprimer-déclaration-moto.php?table=moto&id=<?php echo $moto['id'];?>&numchassis=<?php echo $moto['num_chassis'];?>&just=<?= $moto['justificatif'];?>&photo=<?= $moto['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-moto.php?table=moto&id=<?php echo $moto['id'];?>&numchassis=<?php echo $moto['num_chassis'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
<?php endforeach  ?>

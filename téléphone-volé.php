...
<body>
  ...
  <section class="banner">
    <header>
      <a href="detection-telephone.php?num=<?=$number?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
   
    </header>  
     <h2>attention le téléphone qui vous interesse a était déja volé  <script src="https://cdn.lordicon.com/lusqsztk.js"></script>
<lord-icon
...
<div class="container">
    ...
    <div class="form" id="form">
       ...
       <li><p> marque</p> <?php echo $telinfo['marque'];?></li>
  <img  src="téléphones-déclarés/<?php echo $telinfo['photo'];?>" height="280px" width="330px">
    <ul>
        <li> <p>nom: </p><?php echo $telinfo['nom_appareil'];?> </li>
        <li> <p>numero de serie:</p> <?php echo $telinfo['num_s'];?></li>
        <li> <p>couleur:</p><?php echo $telinfo['couleur'];?> </li>

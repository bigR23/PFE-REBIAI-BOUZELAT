...
if(isset($_SESSION['nomadmin'])){
 ...
 $userinfo=$requser->fetch();
   ...
   if($table=="casque_vr"){   
        $nums=$_GET['nums'];
        $reqvalider=$pdo->prepare("UPDATE casque_vr SET confirmation=? WHERE num_s=? AND id=?");
...
; header("Location:admin-vr.php?msg2=déclaration-validée&nomadmin=".$ad);
   }
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="admin-vr.php?nomadmin=<?=$ad?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
    </header>

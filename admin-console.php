...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de consoles &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
...
<?php 
     ...
     ?>
     <li>
     <a>ID=<?= $console['id'];?>) </a><a href="consoles-déclarés/<?= $console['photo'];?>"><?=$console['nom_appareil'];?> :</a> <a href="justificatifs-console/<?= $console['justificatif'];?>">Justificatif</a>
     <a href="supprimer-déclaration-console.php?table=console&id=<?php echo $console['id'];?>&nums=<?php echo $console['num_s'];?>&just=<?= $console['justificatif'];?>&photo=<?= $console['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-console.php?table=console&id=<?php echo $console['id'];?>&nums=<?php echo $console['num_s'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
<?php endforeach  ?>
     </div>   

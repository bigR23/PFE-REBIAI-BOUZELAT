...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de Smart watch &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
...
<?php 
     ...
     ?>
     <li>
     <a>ID=<?= $sw['id'];?>) </a><a href="SmartWatch-déclarés/<?= $sw['photo'];?>"><?=$sw['nom_appareil'];?> :</a> <a href="justificatifs-SmartWatch/<?= $sw['justificatif'];?>">Justificatif</a>
     <a href="supprimer-déclaration-sw.php?table=smart_watch&id=<?php echo $sw['id'];?>&imei=<?php echo $sw['imei'];?>&just=<?= $sw['justificatif'];?>&photo=<?= $sw['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-sw.php?table=smart_watch&id=<?php echo $sw['id'];?>&imei=<?php echo $sw['imei'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
<?php endforeach  ?>

...
$number=$_GET['num'];
if(isset($_GET['numchassis'])){
	$getnumchassis=$_GET['numchassis'];
	$reqv=$pdo->prepare("SELECT * FROM voiture WHERE num_chassis= ?");
	$reqv->execute(array($getnumchassis));
	$vinfo=$reqv->fetch();
 if(isset($_SESSION['num_chassis'])AND $vinfo['num_chassis']==$_SESSION['num_chassis']){
  $ID=$vinfo['id'];
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="detection-voiture.php?num=<?=$number?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
   
    </header>  
     <h2>attention la voiture qui vous interesse a était déja volée  <script src="https://cdn.lordicon.com/lusqsztk.js"></script>
<lord-icon
...
<div class="container">
    ...
    <div class="form" id="form">
       ...
       <li><p> marque de voiture</p> <?php echo $vinfo['marque'];?></li>
  <img  src="voitures-déclarés/<?php echo $vinfo['photo'];?>" height="280px" width="330px">
    <ul>
        <li> <p>nom de voiture: </p><?php echo $vinfo['nom_voiture'];?> </li>
        <li> <p>matricule:</p> <?php echo $vinfo['matricule'];?></li>
        <li> <p>couleur:</p><?php echo $vinfo['couleur'];?> </li>

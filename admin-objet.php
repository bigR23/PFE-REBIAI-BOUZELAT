...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations d'autre objets &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
...
<?php 
     ...
     ?>
     <li>
        <a>ID=<?= $objet['id'];?>) </a><a href="autreobjets-déclarés/<?= $objet['photo'];?>"><?=$objet['nature'];?> :</a> <a href="justificatifs-autre/<?= $objet['justificatif'];?>">Justificatif</a>
    <a href="supprimer-déclaration-obj.php?table=objet&id=<?php echo $objet['id'];?>&nums=<?php echo $objet['num_s'];?>&just=<?= $objet['justificatif'];?>&photo=<?= $objet['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-obj.php?table=objet&id=<?php echo $objet['id'];?>&nums=<?php echo $objet['num_s'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
<?php endforeach  ?>

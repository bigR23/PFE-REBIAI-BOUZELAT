...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de vélos &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
...
<?php 
     ...
     ?>
     <li>
       <a>ID=<?= $velo['id'];?>) </a><a href="vélos-déclarés/<?= $velo['photo'];?>">Vélo <?=$velo['marque'];?> :</a> <a href="justificatifs-vélo/<?= $velo['justificatif'];?>">Justificatif</a>
       <a href="supprimer-déclaration-velo.php?table=velo&id=<?php echo $velo['id'];?>&nums=<?php echo $velo['num_s'];?>&just=<?= $velo['justificatif'];?>&photo=<?= $velo['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-velo.php?table=velo&id=<?php echo $velo['id'];?>&nums=<?php echo $velo['num_s'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
<?php endforeach  ?>

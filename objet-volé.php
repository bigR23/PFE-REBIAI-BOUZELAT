...
if(isset($_GET['nums'])){
	$getnums=$_GET['nums'];
	$req=$pdo->prepare("SELECT * FROM objet WHERE num_s= ?");
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="detection-objet.php?num=<?=$number?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
   
    </header>  
     <h2>attention l'objet qui vous interesse a était déja volé  <script src="https://cdn.lordicon.com/lusqsztk.js"></script>
<lord-icon
...
<div class="container">
    ...
    <div class="form" id="form">
       ...
       <li><p> nature</p> <?php echo $info['nature'];?></li>
  <img  src="autreobjets-déclarés/<?php echo $info['photo'];?>" height="300px" width="330px">
    <ul>

...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de tablettes &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
    ...
    <?php 
     ...
     ?>
     <li>
   <a>ID=<?= $tablette['id'];?>) </a><a href="tablettes-déclarés/<?= $tablette['photo'];?>"><?=$tablette['nom_appareil'];?> :</a> <a href="justificatifs-tab/<?= $tablette['justificatif'];?>">Justificatif</a>
       <a href="supprimer-déclaration-tab.php?table=tablette&id=<?php echo $tablette['id'];?>&imei=<?php echo $tablette['emei'];?>&just=<?= $tablette['justificatif'];?>&photo=<?= $tablette['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-tab.php?table=tablette&id=<?php echo $tablette['id'];?>&imei=<?php echo $tablette['emei'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>
      <hr>
<?php endforeach  ?>

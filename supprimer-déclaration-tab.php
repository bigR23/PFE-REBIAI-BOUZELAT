...
<link rel="stylesheet" href="css/all.css"/>
		...
		align="center">
			<br />
			<p style="font-size:1.2em;color:#fff ;margin: 20px 0px;text-shadow:0 0 4px #000000;"> Votre déclaration de tablette a était <strong style="color:red">rejeté</strong> pour le motif suivant :</p>
...
mail($mail, "réponse à votre demande de déclaration !", $message, $header);
   ...
   header("Location:admin-tab.php?msg=déclaration-supprimée&nomadmin=".$ad);
   }
}
?>
<!doctype html>
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="admin-tab.php?nomadmin=<?=$ad?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
    </header>

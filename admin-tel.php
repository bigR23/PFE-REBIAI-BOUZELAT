...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de téléphones &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
    ...
    <?php 
     ...
     ?>
     <li>
   <a>ID=<?= $telephone['id'];?>) </a><a href="téléphones-déclarés/<?= $telephone['photo'];?>">  <?=$telephone['nom_appareil'];?> :</a> <a href="justificatifs-tel/<?= $telephone['justificatif'];?>">Justificatif</a>
       <a href="supprimer-déclaration-tel.php?table=telephone&id=<?php echo $telephone['id'];?>&imei=<?php echo $telephone['emei'];?>&just=<?= $telephone['justificatif'];?>&photo=<?= $telephone['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-tel.php?table=telephone&id=<?php echo $telephone['id'];?>&imei=<?php echo $telephone['emei'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>
      <hr>
<?php endforeach  ?>

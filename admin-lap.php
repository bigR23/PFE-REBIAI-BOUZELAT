...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de laptops &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
  ...
  <?php 
     ...
     ?>
     <li>
       <a>ID=<?= $laptop['id'];?>) </a><a href="laptops-déclarés/<?= $laptop['photo'];?>"><?=$laptop['nom_appareil'];?> :</a> <a href="justificatifs-lap/<?= $laptop['justificatif'];?>">Justificatif</a>
       <a href="supprimer-déclaration-lap.php?table=laptop&id=<?php echo $laptop['id'];?>&nums=<?php echo $laptop['num_s'];?>&just=<?= $laptop['justificatif'];?>&photo=<?= $laptop['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-lap.php?table=laptop&id=<?php echo $laptop['id'];?>&nums=<?php echo $laptop['num_s'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
<?php endforeach  ?>

...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations d'appareils photos &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
   
     <div class="liste"> 
    <ul>
    <?php if (isset($erreur)){echo '<p>'.$erreur.'</p>';}?> 
     <!-- afficher les appareil_photo déclarés -->
  <?php 
     foreach( $appinfo as $appareilphoto):
        ?>
        <li>
        <a>ID=<?= $appareilphoto['id'];?>) </a><a href="appareils-photo-déclarés/<?= $appareilphoto['photo'];?>"><?=$appareilphoto['nom_appareil'];?> :</a> <a href="justificatifs -appareil-photo/<?= $appareilphoto['justificatif'];?>">Justificatif</a>
       <a href="supprimer-déclaration-app.php?table=appareil_photo&id=<?php echo $appareilphoto['id'];?>&nums=<?php echo $appareilphoto['num_s'];?>&just=<?= $appareilphoto['justificatif'];?>&photo=<?= $appareilphoto['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-app.php?table=appareil_photo&id=<?php echo $appareilphoto['id'];?>&nums=<?php echo $appareilphoto['num_s'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
   <?php endforeach  ?>

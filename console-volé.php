...
if(isset($_GET['nums'])){
	$getnums=$_GET['nums'];
	$req=$pdo->prepare("SELECT * FROM console WHERE num_s= ?");
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="detection-console.php?num=<?=$number?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
   
    </header>  
     <h2>attention la console qui vous interesse a était déja volé  <script src="https://cdn.lordicon.com/lusqsztk.js"></script>
<lord-icon
...
<div class="container">
  ...
  <img  src="consoles-déclarés/<?php echo $info['photo'];?>" height="280px" width="330px">
    <ul>

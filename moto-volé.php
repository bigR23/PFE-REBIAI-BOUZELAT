...
if(isset($_GET['numchassis'])){
	...
	$reqv=$pdo->prepare("SELECT * FROM moto WHERE num_chassis= ?");
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="detection-moto.php?num=<?=$number?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
   
    </header>  
     <h2>attention la moto qui vous interesse a était déja volée  <script src="https://cdn.lordicon.com/lusqsztk.js"></script>
<lord-icon
...
<div class="container">
    ...
    <div class="form" id="form">
       ...
       <li><p> marque de moto</p> <?php echo $vinfo['marque'];?></li>
  <img  src="motos-déclarés/<?php echo $vinfo['photo'];?>" height="280px" width="330px">
    <ul>
        <li> <p>nom de moto: </p><?php echo $vinfo['nom_moto'];?> </li>

...
<link rel="stylesheet" href="css/all.css"/>
		...
		align="center">
			<br />
			<p style="font-size:1.2em;color:#fff ;margin: 20px 0px;text-shadow:0 0 4px #000000;"> Votre déclaration de téléphone a était <strong style="color:red">rejeté</strong> pour le motif suivant :</p>
...
mail($mail, "réponse à votre demande de déclaration !", $message, $header);
   ...
   header("Location:admin-tel.php?msg=déclaration-supprimée&nomadmin=".$ad);
   }
}
?>
<!doctype html>

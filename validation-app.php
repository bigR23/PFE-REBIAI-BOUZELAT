...
if(isset($_SESSION['nomadmin'])){
 ...
 $userinfo=$requser->fetch();
   ...
   if($table=="appareil_photo"){   
        $nums=$_GET['nums'];
        $reqvalider=$pdo->prepare("UPDATE appareil_photo SET confirmation=? WHERE num_s=? AND id=?");
...
<link rel="stylesheet" href="css/all.css"/>
		...
		align="center">
			<br />
			<p style="font-size:1.3em;color:#fff ;margin: 20px 0px;text-shadow:0 0 4px #000000;"> Votre déclaration d\'appareil photo a était <strong style="color:rgb(0,236,173);">acceptée </strong> par nos services</p>
...
; header("Location:admin-app.php?msg2=déclaration-validée&nomadmin=".$ad);
   }
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="admin-app.php?nomadmin=<?=$ad?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
    </header>

...
if(isset($_GET['nums'])){
	$getnums=$_GET['nums'];
	$req=$pdo->prepare("SELECT * FROM appareil_photo WHERE num_s= ?");
...
<body>
  ...
  <section class="banner">
    <header>
      <a href="detection-appareil-photo.php?num=<?=$number?>" class="re" ><i id ="icon"class="fas fa-arrow-alt-circle-left"></i> Retour</a>
   
    </header>  
     <h2>attention l'appareil photo qui vous interesse a était déja volé  <script src="https://cdn.lordicon.com/lusqsztk.js"></script>
<lord-icon
...
<div class="container">
  ...
  <img  src="appareils-photo-déclarés/<?php echo $info['photo'];?>" height="280px" width="330px">
    <ul>

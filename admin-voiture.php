...
<body>
  ...
  echo '<p><i class="fa-solid fa-list-check" style="color:rgb(0,236,173);"></i> '."La décalaration a était supprimée !"."</p>";
     ...
     <h2> liste des déclarations de voitures &emsp;<i id ="icon"class="fa-solid fa-clipboard-list"></i></h2>
    <div class="content">
  ...
  <?php 
     ...
     ?>
     <li>
     <a>ID=<?= $voiture['id'];?>) </a><a href="voitures-déclarés/<?= $voiture['photo'];?>"><?=$voiture['nom_voiture'];?> :</a> <a href="justificatifs-voiture/<?= $voiture['justificatif'];?>">Justificatif</a>
       <a href="supprimer-déclaration-voi.php?table=voiture&id=<?php echo $voiture['id'];?>&numchassis=<?php echo $voiture['num_chassis'];?>&just=<?= $voiture['justificatif'];?>&photo=<?= $voiture['photo'];?>"> &emsp;&emsp;<img class="icon-list"src="img/no.png" height="45px"style="position:relative;top:17px;"></a>
   &emsp;&emsp;  <a href="validation-voi.php?table=voiture&id=<?php echo $voiture['id'];?>&numchassis=<?php echo $voiture['num_chassis'];?>"><img class="icon-list"src="img/yes.png" height="40px"style="position:relative;top:14px;"></a>
      </li><br>   <hr>
<?php endforeach  ?>
